...
₹<?php echo number_format($fee_info['total_fee']); ?>
...
₹<?php echo number_format($fee_info['pending_amount']); ?>
...
<?php if($fee_info['payment_status'] == 'Paid'): ?>
...
<td>
<?php echo $fee_info['payment_date']; ?>
</td>
